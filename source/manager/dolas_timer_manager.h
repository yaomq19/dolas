...
namespace Dolas
{
    ...
    public:
        ...
        void Clear();
        void Tick();
        void LimitFrameRate(); // Limit frame rate based on max FPS setting
        ...
        void SetMaxFPS(Float max_fps); // Set maximum frame rate
    ...
    protected:
        ...
        Float m_max_fps; // Maximum frame rate limit (0 = unlimited)
    };
} // namespace dolas
